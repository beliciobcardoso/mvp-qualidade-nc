      ...
      {photoAnalisys.length > 0 ? (
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
          {photoAnalisys.map((item, index) => (
            <Card key={item.id} className="flex flex-col items-center justify-between truncate">
              <CardContent className="w-[380px] h-[300px] flex items-center justify-center p-0">
                <Image src={item.url} alt="Imagem" width={350} height={350} />
              </CardContent>
