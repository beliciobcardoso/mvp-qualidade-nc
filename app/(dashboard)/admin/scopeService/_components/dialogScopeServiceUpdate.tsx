...
import type { dialogScopeServiceProps } from '@/lib/types'
import { zodResolver } from '@hookform/resolvers/zod'
import { useRouter } from 'next/navigation'
import { useState } from 'react'
import { useForm } from 'react-hook-form'
import { updateScopeService } from '../actions'

export function DialogScopeServiceUpdate({
  dialogButton,
  dialogTitle,
  dialogDescription,
  dialogData,
}: dialogScopeServiceProps) {
