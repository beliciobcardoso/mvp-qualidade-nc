  ...
  return (
    <div className="flex flex-col items-center justify-start gap-2">
      ...
      <div className="flex justify-center gap-4">
        <Button variant="outline" size="icon" onClick={() => rotate('left')} disabled={!processedImage}>
          <RotateCcw className="h-4 w-4" />
        </Button>
        <Button variant="outline" size="icon" onClick={() => rotate('right')} disabled={!processedImage}>
