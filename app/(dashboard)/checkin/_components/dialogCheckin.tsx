...
import type { CheckInType, DialogNewProps } from '@/lib/types'
...
export function DialogCheckIn({ dialogButton, dialogTitle, dialogDescription }: DialogNewProps) {
  ...
  async function onSubmit(values: CheckInType) {
    try {
