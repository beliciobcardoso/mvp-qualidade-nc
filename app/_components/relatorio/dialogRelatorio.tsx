...
export function DialogRelatorio({
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      nomeCliente: relatorio ? relatorio.nomeCliente : '',
      idSite: relatorio ? relatorio.idSite : '',
      altura: relatorio ? relatorio.altura : '',
      endereco: relatorio ? relatorio.endereco : '',
      bairro: relatorio ? relatorio.bairro : '',
      numero: relatorio ? relatorio.numero : '',
      cidade: relatorio ? relatorio.cidade : '',
      uf: relatorio ? relatorio.uf : '',
      tecnico: relatorio ? relatorio.tecnico : '',
      dataServico: relatorio ? new Date(relatorio.dataServico) : new Date(),
      tipoSite: relatorio ? relatorio.tipoSite : '',
